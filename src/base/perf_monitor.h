...
typedef enum
{
  ...
  PERFMON_ACTIVATION_FLAG_DETAILED_HEAP_PAGE = 256,
  ...
  PERFMON_ACTIVATION_FLAG_DEFAULT_VALUE = 15 | PERFMON_ACTIVATION_FLAG_DETAILED_HEAP_PAGE
...
typedef enum
{
  ...
  PERF_PAGE_HEAP_HEADER,        /* heap header */
  PERF_PAGE_CNT
} PERF_PAGE_TYPE;
